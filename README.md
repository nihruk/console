...
- To run unit tests against the IODA application, run `bin/phpunit --testsuite unit`
- To run integration tests against the IODA application, run `bin/phpunit --testsuite integration`
